...
public class HBase {
    public static void main(String[] args) throws IOException {
        ...
        //Create Table
        TableName tableName = TableName.valueOf("quezhongqing:student");
        if (admin.tableExists(tableName)) {
            ...
            try {
                ...
                admin.createNamespace(NamespaceDescriptor.create("quezhongqing").build());
                admin.createTable(hTableDescriptor);
            }
        ...
        //Query
        Get get = new Get(Bytes.toBytes("Que Zhongqing"));
        ...
        // Delete Record
        Delete delete = new Delete(Bytes.toBytes("Que Zhongqing"));
